...
We pledge to foster an environment focused on advancing our mission: building excellent open-source solutions for **Secure Reliable Transport (SRT)** video routing, streaming gateways, and related infrastructure. We commit to maintaining a professional, respectful, and harassment-free environment that enables all contributors to focus on technical excellence and project advancement.
...
Violations can be reported to the project maintainers at [root@abc3.dev](mailto:root@abc3.dev). For other ways to reach the project, see [Contact](README.md#contact) in the README. All complaints will be reviewed and investigated promptly, focusing on maintaining project momentum and professional standards. Maintainers will respect reporter privacy and handle incidents with appropriate discretion.
