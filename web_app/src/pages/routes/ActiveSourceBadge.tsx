...
import type { RouteActiveSourceView } from '../../types/routes';

const formatSwitchMeta = (reason?: string, timestamp?: string): string => {
  if (!reason && !timestamp) {
...
const ActiveSourceBadge = ({ route }: { route?: RouteActiveSourceView }): JSX.Element => {
