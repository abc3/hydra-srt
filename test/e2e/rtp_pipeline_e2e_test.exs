defmodule HydraSrt.E2E.RtpPipelineE2ETest do
  ...
  test "RTP basic: MPEG-TS over RTP source forwards to SRT destination", %{base_url: base_url} do
    ...
    assert E2EHelpers.await_tag_exit_status("ffmpeg-rtp-basic", 10_000) == 0
  end
end
